...
SRSAuto.SERVER_SRS_HOST_AUTO = true -- if set to true SRS will set the SERVER_SRS_HOST for you! - Currently disabled
SRSAuto.SERVER_SRS_PORT = "5002" --  SRS Server default is 5002 TCP & UDP
SRSAuto.SERVER_SRS_HOST = "44.230.215.217" -- overridden if SRS_HOST_AUTO is true -- set to your PUBLIC ipv4 address
